...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  computed: {
    base64payload: function base64payload() {
      var payload = {
  ...
  methods: {
    ...
    startPhonepePayment: function startPhonepePayment() {
      var sha3 = js_sha256__WEBPACK_IMPORTED_MODULE_0___default()(this.base64payload + "/v4/debit" + "8289e078-be0b-484d-ae60-052f117f8deb");
      console.log(sha3);
      var config = {
        headers: {
      ...
      axios__WEBPACK_IMPORTED_MODULE_1___default.a.post("https://mercury-uat.phonepe.com/v4/debit/", {
